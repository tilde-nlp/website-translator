...
import IWebsite from './src/js/interfaces/Services/WebsiteService/IWebsite'
...
async function Initialize () {
  if (!pluginInitializationHappened) {
    ...
    pluginOptions.sourceLanguage = website.sourceLanguage
    pluginOptions.translation.targetLanguages = website.targetLanguages
